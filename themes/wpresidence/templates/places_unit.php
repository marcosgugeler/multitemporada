...
<div class=" <?php echo esc_html($col_class);?> listing_wrapper" data-org="<?php echo esc_attr($col_org);?>" > 
    
    <div class="property_listing places_listing" data-link="<?php echo esc_attr($term_link);?>"    style="background-image: url(<?php print esc_attr($category_featured_image_url); ?>)" >
