<div class="property_reviews_wrapper panel-group property-panel">
    ...
    <h4><?php esc_html_e('Property Reviews ','wpresidence');?></h4>
    <?php 
    $args = array(
        'number' => '15',
        ...
        $review_templates.='  
             <div class="listing-review">
                            ...
                            <div class=" review-list-content norightpadding">
                                <div class="reviewer_image"  style="background-image: url('.esc_attr($preview_img).');"></div>
                                ...
                                $review_templates.=' <span class="ratings-star">('. $rating.' ' .esc_html__( 'of','wpresidence').' 5)</span> 
                                </div>
...
?>
    <h5 class="review_notice"><?php esc_html_e('You need to ','wpresidence');echo '<span id="login_trigger_modal">'.esc_html__('login','wpresidence').'</span> ';esc_html_e('in order to post a review ','wpresidence');?></h5>
<?php
    }
?>
