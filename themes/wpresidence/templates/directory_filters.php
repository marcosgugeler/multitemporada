...
<div class="directory_sidebar_wrapper">
    ...
    <div class="property_status_wrapper">
        ...
        <option value="normal"><?php esc_html_e('Property Status','wpresidence');?></option>
               ...
               if (function_exists('icl_translate') ){
                ...
                if($value!='none'){
                    ...
                    <div class="extended_search_checker '.$input_name.'_directory">
                        ...
                        <label class="directory_checkbox" for="'.esc_attr($input_name).'widget">'.esc_html($value).'</label>
                    </div>';
                }
        }
        ?>
