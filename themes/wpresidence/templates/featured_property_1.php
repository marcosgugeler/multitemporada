...
$return_string.= '
    <div class="featured_property featured_property_type1">     <div class="featured_prop_price">'.$price.' </div>';
            ...
            $return_string .= '<div class="tag-wrapper">';
                ...
                $return_string .= '<div class="status-wrapper">';
                if ($prop_stat != 'normal') {
            ...
            $return_string .= '</div></div>';
                if(  $wpestate_property_unit_slider==1){
                    ...
                    <div id="property_unit_featured_carousel_'.intval($prop_id).'" class="carousel slide  " data-ride="carousel" data-interval="false">
                        <div class="carousel-inner">         
                            <div class="item active">    
                                <a href="'.esc_url($link).'"><img src="' . esc_url($preview[0]) . '" data-original="' . esc_attr($preview[0]) . '" class="lazyload img-responsive" alt="'.esc_html__('image','wpresidence').'"/></a>     
                            </div>
                            '.$slides.'
                        </div>
                    ...
                    $return_string .=  '<a href="' . esc_url($link) . '"> <img src="' . esc_url($preview[0]) . '" data-original="' . esc_attr($preview[0]) . '" class="lazyload img-responsive" alt="'.esc_html__('image','wpresidence').'"/></a>
                    <div class="listing-cover featured_cover" data-link="'.esc_attr($link).'"></div>
            ...
            if ($agent_id!=''){
                ...
                <div class="agent_face">
                    ...
                    <img src="'.esc_url($agent_face[0]).'" width="55" height="55" class="img-responsive" alt="'.esc_html__('user image','wpresidence').'">


                    <div class="agent_face_details">
                        <img src="'.esc_url($agent_face[0]).'" width="120" height="120" class="img-responsive" alt="'.esc_html__('user image','wpresidence').'">
