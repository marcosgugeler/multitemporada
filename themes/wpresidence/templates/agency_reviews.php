<div class="property_reviews_wrapper">
    ...
    <h4><?php esc_html_e('Agency Reviews ','wpresidence');?></h4>
    ...
    if ( is_user_logged_in() ) {   
        ...
        <div class="add_review_wrapper">
            ...
            <textarea rows="8" id="wpestare_review_content" name="wpestare_review_content" class="form-control" placeholder="<?php  esc_html_e('Your Review','wpresidence'); ?>"><?php 
                if( $user_posted_coment!=0  ){
                    print esc_html($comment_content);
                } 
                ?></textarea>
            <?php 
            ...
            if( $user_posted_coment!=0){ ?>
                <input type="submit" class="wpresidence_button col-md-3" id="edit_review" data-coment_id="<?php print intval($user_posted_coment);?>" data-listing_id="<?php print intval($post->ID);?>" value="<?php esc_html_e('Edit Review','wpresidence');?>">
            <?php
            }else{?>
