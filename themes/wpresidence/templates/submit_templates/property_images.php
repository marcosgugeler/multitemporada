    ...
    if ($action=='edit'){
        ...
        foreach ($post_attachments as $attachment) {
            ...
            if($preview[0]!=''){
                ...
                $images .=  '<div class="uploaded_images" data-imageid="'.esc_attr($attachment->ID).'"><img src="'.get_theme_file_uri('/img/pdf.png').'" alt="'.esc_html__('user image','wpresidence').'" /><i class="fa fa-trash-o"></i>';
                if($post_thumbnail_id == $attachment->ID){
                    $images .='<i class="fa thumber fa-star"></i>';
                }
            }
                                ...
                                if ( $attachid!='' && $action!='edit' ){
                                    ...
                                    foreach($attchs as $att_id){
                                        if( $att_id!='' && is_numeric($att_id) ){
                                            ...
                                            if($preview[0]!=''){
                                                $images .=  '<div class="uploaded_images" data-imageid="'.esc_attr($att_id).'"><img src="'.esc_url($preview[0]).'" alt="'.esc_html__('user image','wpresidence').'" /><i class="fa fa-trash-o"></i>';

                                            }else{
                                                $images .=  '<div class="uploaded_images" data-imageid="'.esc_attr($att_id).'"><img src="'.get_theme_file_uri('/img/pdf.png').'" alt="'.esc_html__('user image','wpresidence').'" /><i class="fa fa-trash-o"></i>';
