...
$return_string.= '
    <div class="featured_property featured_property_type2">';
                ...
                if(  $wpestate_property_unit_slider==1){
                    ...
                    $return_string .=  '<a href="'.esc_url($link).'"> <img src="'.esc_url($preview[0]) . '" data-original="'.esc_attr( $preview[0]).'" class="lazyload img-responsive" alt="'.esc_html__('user image','wpresidence').'"/></a>
            ...
            $return_string.= '<div class="places_cover" data-link="'.esc_attr($link).'" ></div> <div class="featured_secondline" >';
            if ($agent_id!=''){
                $return_string.= '
                <div class="agent_face" style="background-image:url('.esc_url($agent_face[0]).')">
