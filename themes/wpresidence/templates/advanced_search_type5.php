...
<div class="adv-search-1 <?php echo esc_attr($close_class.' '.$extended_class);?>" id="adv-search-1" > 
    ...
    <form role="search" method="get"   action="<?php print esc_url($adv_submit); ?>" >
        ...
        <div class="adv5-holder">
            ...
            if ( $custom_advanced_search == 'yes'){
                ...
                print '<input name="submit" type="submit" class="wpresidence_button" id="advanced_submit_4" value="'.esc_html__('Search Properties','wpresidence').'">';
                print '</div>';
            }else{
