    ...
    <div class="featured_property featured_property_type3">
            <div class="featured_img">';
                ...
                if(  $wpestate_property_unit_slider==1){
                    ...
                    $return_string .=  '<a href="'.esc_url($link).'"> <div class="feat_img" style="background-image:url('.esc_url($preview[0]).');"></div></a>
           ...
           $return_string.='<div class="property_listing_details">';
                    ...
                    if($property_size!=''){
                        $return_string.='<span class="infosize">'.($property_size).'</span>';//esca[ed above
                    }
         $return_string.='</div>';
