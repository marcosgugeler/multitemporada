...
function wpestate_remove_dashboard_widgets() {
    ...
    if( current_user_can('administrator')){
        wp_add_dashboard_widget( 'wpestate_dashboard_welcome', esc_html__('Personalize Your Website','wpresidence'), 'wpestate_add_welcome_widget' );
...
function wpestate_admin_login_logo() { 
        ...
        body.login {
            background-image: url(<?php print get_theme_file_uri('/img/admin_background.png');?>);
        }
