...
function wpestate_show_license_form(){
    ...
    if($theme_activated!='is_active'){
        ...
        print '<div class="license_check_wrapper" id="license_check_wrapper">';
            echo' <div class="activate_notice notice_here">'.esc_html__('Please activate the theme to validate the purchase and to have access to DEMO CONTENT! See this link  ','wpresidence') .'<a href="http://help.wpresidence.net/article/how-to-get-your-buyer-license-code/" target="_blank">link</a> '.esc_html__('if you don\'t know how to get your license key. Thank you!','wpresidence').'</div>';
      ...
      //  wp_verify_nonce($_POST['security'],'wpestate_ajax_filtering');
        ...
        if ($user_id!=0 && $user_id!=''){
            ...
            <ul id="user_menu_open" class="dropdown-menu menulist topmenux" role="menu" aria-labelledby="user_menu_trigger">     
                <li role="presentation"><a role="menuitem" tabindex="-1" href="'.$dash_profile.'"  class="active_profile"><i class="fa fa-cog"></i>'.esc_html__('My Profile','wpresidence').'</a></li>
                <li role="presentation"><a role="menuitem" tabindex="-1" href="'.$dash_link.'"     class="active_dash"><i class="fa fa-map-marker"></i>'.esc_html__('My Properties List','wpresidence').'</a></li>
                <li role="presentation"><a role="menuitem" tabindex="-1" href="'.$add_link.'"      class="active_add"><i class="fa fa-plus"></i>'.esc_html__('Add New Property','wpresidence').'</a></li>
                <li role="presentation"><a role="menuitem" tabindex="-1" href="'.$dash_favorite.'" class="active_fav"><i class="fa fa-heart"></i>'.esc_html__('Favorites','wpresidence').'</a></li>
                <li role="presentation"><a role="menuitem" tabindex="-1" href="'.$dash_searches.'" class="active_fav"><i class="fa fa-search"></i>'. esc_html__('Saved Searches','wpresidence').'</a></li>
                <li role="presentation"><a role="menuitem" tabindex="-1" href="'.$dash_invoices.'" class="active_fav"><i class="fa fa-file-text-o"></i>'.esc_html__('My Invoices','wpresidence').'</a></li>
                <li role="presentation"><a role="menuitem" tabindex="-1" href="'.$dash_inbox.'" class="active_fav"><i class="fa fa-envelope-o"></i>'.esc_html__('Inbox','wpresidence').'</a>';
                ...
                <li role="presentation"><a href="'. wp_logout_url( esc_url(home_url('/')) ).'" title="Logout" class="menulogout"><i class="fa fa-power-off"></i>'.esc_html__('Log Out','wpresidence').'</a></li>
            </ul>';
