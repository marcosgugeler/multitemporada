...
function wpestate_scripts() {     
    ...
    if($mimify_prefix===''){
        wp_enqueue_style('wpestate_style',get_stylesheet_uri(), array('bootstrap.min','bootstrap-theme.min'), '1.0', 'all');  
    }else{
        wp_enqueue_style('wpestate_style',get_theme_file_uri('/style.min.css'), array('bootstrap.min','bootstrap-theme.min'), '1.0', 'all');  
    }
   
    wp_enqueue_style('wpestate_media',get_theme_file_uri('/css/my_media'.$mimify_prefix.'.css'), array(), '1.0', 'all'); 
    ...
    wp_enqueue_style( 'font-awesome.min',  get_theme_file_uri( '/css/fontawesome/css/font-awesome.min.css') );  
    ...
    wp_enqueue_script('anime.min', get_template_directory_uri().'/js/anime.min.js',array('jquery'), '1.0', true); 
    wp_enqueue_script('jquery.matchHeight-min', get_template_directory_uri().'/js/jquery.matchHeight-min.js',array('jquery'), '1.0', true); 
    wp_enqueue_script('owl_carousel', get_template_directory_uri().'/js/owl.carousel.min.js',array('jquery'), '1.0', true); 
    wp_enqueue_script('jquery.fancybox.pack', get_template_directory_uri().'/js/jquery.fancybox.pack.js',array('jquery'), '1.0', true); 
    wp_enqueue_script('jquery.fancybox-thumbs', get_template_directory_uri().'/js/jquery.fancybox-thumbs.js',array('jquery'), '1.0', true); 
    wp_enqueue_script('dense.min', get_template_directory_uri().'/js/dense.min.js',array('jquery'), '1.0', true); 
    wp_enqueue_script('placeholders.min', get_template_directory_uri().'/js/placeholders.min.js',array(), '1.0', true); 
    wp_enqueue_script('slick.min', get_template_directory_uri().'/js/slick.min.js',array(), '1.0', true); 
    wp_enqueue_script('modernizr.custom.62456', get_template_directory_uri().'/js/modernizr.custom.62456.js',array(), '1.0', false); 
    ...
    if ( is_singular('estate_property') || is_page_template('user_dashboard.php') || is_page_template('user_dashboard_search_result.php')  ){
        wp_enqueue_script('jquery.chart.min', get_theme_file_uri('/js/Chart.min.js'),array('jquery'), '1.0', true);
        wp_enqueue_script('venobox.min', get_template_directory_uri().'/js/venobox.min.js',array('jquery'), '1.0', true); 
    ...
    if($date_lang_status!='xx' && $date_lang_status!=''){
        ...
        wp_enqueue_script($handle, get_theme_file_uri('/js/i18n/'.$name),array('jquery'), '1.0', true);
    }
    ...
    wp_enqueue_script('touch-punch',    get_theme_file_uri ('/js/jquery.ui.touch-punch.min.js'),array('jquery'), '1.0', true);
    ...
    if($idx_status=='yes'){
       wp_enqueue_script('idx', get_theme_file_uri( '/js/google_js/idx'.$mimify_prefix.'.js'),array('jquery'), '1.0', true); 
    } 
    ...
    if( get_post_type() === 'estate_property' && !is_tax() &&!is_search() ){
        ...
        wp_enqueue_script('googlecode_property', get_theme_file_uri('/js/google_js/google_map_code_listing'.$mimify_prefix.'.js') ,array('jquery','wpestate_mapfunctions_base'), '1.0', true); 
        ...
        $load_extra =   1;
        if($custom_image    ==  ''){  
          wp_enqueue_script('googlecode_contact', get_theme_file_uri('/js/google_js/google_map_code_contact'.$mimify_prefix.'.js'),array('jquery','wpestate_mapfunctions_base'), '1.0', true);        
          ...
          wp_localize_script('googlecode_contact', 'googlecode_contact_vars', 
            ...
            if($header_type==5 || $global_header_type==4){           
                ...
                wp_enqueue_script('googlecode_regular', get_theme_file_uri('/js/google_js/google_map_code'.$mimify_prefix.'.js'),array('jquery','wpestate_mapfunctions_base'), '1.0', true);        
   ...
   $measure_sys             = wpresidence_get_option('wp_estate_measure_sys','');
    ...
    wp_enqueue_script('mapfunctions', get_theme_file_uri('/js/google_js/mapfunctions'.$mimify_prefix.'.js'),array('jquery'), '1.0', true);   
    ...
    wp_enqueue_script('wpestate_mapfunctions_base', trailingslashit( get_template_directory_uri() ).'js/google_js/maps_base.js',array('jquery','mapfunctions'), '1.0', true);   
    ...
    if(is_page_template('user_dashboard_add.php') || is_page_template('user-dashboard.php') || 
        ...
        wp_enqueue_script('google_map_submit', get_theme_file_uri('/js/google_js/google_map_submit'.$mimify_prefix.'.js'),array('jquery'), '1.0', true);  
    ...
    if(is_singular('estate_property')  || is_singular('estate_agent')  || is_singular('estate_agency') || is_singular('estate_developer') ){
        ...
        wp_enqueue_script('wpestate_property', get_theme_file_uri('/js/property'.$mimify_prefix.'.js'),array('jquery'), '1.0', true);   
    ...
    wp_enqueue_script('control', get_theme_file_uri('/js/control'.$mimify_prefix.'.js'),array('jquery','anime.min','bootstrap'), '1.0', true);   
    wp_localize_script('control', 'control_vars', 
      ...
      wp_enqueue_script('ajaxcalls', get_theme_file_uri('/js/ajaxcalls'.$mimify_prefix.'.js'),array('jquery'), '1.0', true);   
    ...
    if( wpestate_is_user_dashboard() ){
        wp_enqueue_script('dashboard', get_theme_file_uri('/js/dashboard'.$mimify_prefix.'.js'),array('jquery'), '1.0', true);   
    ...
    if( is_page_template('property_list_directory.php') ){
        wp_enqueue_script('directory', get_theme_file_uri('/js/property_directory_control'.$mimify_prefix.'.js'),array('jquery'), '1.0', true);   
    ...
    if( is_page_template('front_property_submit.php') ){
        wp_enqueue_script('front_end_submit', get_theme_file_uri('/js/front_end_submit'.$mimify_prefix.'.js'),array('jquery'), '1.0', true);   
    ...
    if( is_page_template('user_dashboard_profile.php') ||
        ...
        wp_enqueue_script('ajax-upload', get_theme_file_uri('/js/ajax-upload'.$mimify_prefix.'.js'),array('jquery','plupload-handlers'), '1.0', true);  
...
function wpestate_admin($hook_suffix) {	
    ...
    wp_enqueue_script('admin-control', get_theme_file_uri('/js/admin-control.js') , array('jquery'), '1.0', true);     
    ...
    if (is_admin() &&  ( $pagenow=='post-new.php' || $pagenow=='post.php') && ($typenow=='estate_property' || $typenow=='estate_agency' || $typenow=='estate_developer') ) {
        ...
        if($what_map==1){
            if ( is_ssl() ){
                wp_enqueue_script('googlemap',      'https://maps-api-ssl.google.com/maps/api/js?v=3'.$libraries.'&key='.esc_html(wpresidence_get_option('wp_estate_api_key', '') ).'',array('jquery'), '1.0', false);
            }else{
                wp_enqueue_script('googlemap',      'http://maps.googleapis.com/maps/api/js?v=3'.$libraries.'&key='.esc_html(wpresidence_get_option('wp_estate_api_key', '') ).'',array('jquery'), '1.0', false);
            }
        ...
        wp_enqueue_script('admin_google',   get_theme_file_uri('/js/google_js/admin_google.js'),array('jquery'), '1.0', true);      
        ...
        wp_enqueue_script('admin_js', get_theme_file_uri('/js/admin.js'),array('jquery'), '1.0', true); 
        ...
        wp_enqueue_style('colorpicker_css', get_theme_file_uri('/css/colorpicker.css'), false, '1.0', 'all');
        wp_enqueue_script('admin_colorpicker', get_theme_file_uri('/js/admin_colorpicker.js'),array('jquery'), '1.0', true);
        wp_enqueue_script('config-property', get_theme_file_uri('/js/config-property.js'),array('jquery'), '1.0', true);          
