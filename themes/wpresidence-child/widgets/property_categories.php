<?php
class Property_Categories_Child extends WP_Widget {
    function __construct(){

        $widget_ops = array('classname' => 'property_categories_child', 'description' => 'List Properties by Categories');
        $control_ops = array('id_base' => 'property_categories_child');

        parent::__construct('property_categories_child', 'Gugeler Estate: List Properties by Categories', $widget_ops, $control_ops);
}
    ...
    function widget($args, $instance){
        ...
        $display .= wpestate_recursive_category_list_child($items,$taxonony,$show_child,$show_count);
...
function wpestate_recursive_category_list_child($items,$taxonony,$show_child,$show_count){
    $return_string='';
    if($show_child=='yes'){
        $return_string.='<ul>';
    }else{
