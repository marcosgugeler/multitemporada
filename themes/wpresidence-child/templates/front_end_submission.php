        ...
        <div class="col-md-12 add-estate profile-page profile-onprofile row">
            <div class="submit_container">
                ...
                <div class="col-md-4 profile_label">
                    <div class="user_details_row">Informações do imóvel <?php echo $edit_id; ?></div>
                    <div class="user_profile_explain">Escolha ao lado as demais informações sobre o imóvel.</div>
                </div>
                <div class="col-md-8">
                    <?php
                        acf_form(array(
                            'field_groups' => array('group_5c5075357b10d'),
                            'post_id' => ($edit_id)?$edit_id:'new',
                            'form' => true,
                        ));
                    ?>
                </div>
