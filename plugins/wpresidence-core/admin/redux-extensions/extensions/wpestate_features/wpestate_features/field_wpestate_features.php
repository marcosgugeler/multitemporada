...
if( !class_exists( 'ReduxFramework_wpestate_features' ) ) {
    ...
    class ReduxFramework_wpestate_features {
        ...
        public function render() {
            ...
            print '<div class="redux_add_new_feature"><input type="text" id="new_feature" name="new_feature" placeholder="'.esc_html__('type here feature name.. ','wpresidence-core').'" size="40">
                   <a href="#" id="add_feature2"> '.esc_html__('click to add feature','wpresidence-core').' </a></div>';
        }
