...
function estate_header_function(){
    ...
    print'
    <h3 class="pblankh">'.esc_html__('Use transparent header','wpresidence-core').'</h3>
    ...
    print'  <h3 class="pblankh">'.esc_html__('Show Advanced Search?','wpresidence-core').'</h3>';
    print'      
    ...
    if ( 'property_list.php'== basename( get_page_template()) ||  'property_list_directory.php'== basename( get_page_template() )){
        ...
        <p class="meta-options">
            ...
            <select  name="listing_city"  >
                <option value="all">'.esc_html__('All Cities','wpresidence-core').'</option>
                '. $select_city.'
             </select>
        </p>
        ...
        <p class="meta-options">
            ...
            <select  name="listing_area">
                <option data-parentcity="*" value="all">'.esc_html__('All Areas','wpresidence-core').'</option>
                '.$select_area.'
            </select>
        </p>
         ';
