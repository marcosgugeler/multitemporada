...
function wpestate_show_extra_profile_fields( $user ) { ?>
	...
	?>
	<h3><?php echo esc_html__( 'Agent custom data', 'wpresidence' ); ?></h3>
	<table class="form-table">
		<tr>
                    <td colspan="4">
                        <input type="button"   value="<?php echo esc_html__( 'Add Custom Field', 'wpresidence' ); ?>" class="button button-primary add_custom_parameter" /> 
                    </td>
		</tr>
		
		<tr>
                    <td>
                        <label for="twitter"><?php echo esc_html__( 'Parameters list', 'wpresidence' ); ?></label>
                    </td>
                    ...
                    <td>
                        ...
                        <tbody class="add_custom_data_cont">  
                            <tr class="single_parameter_row cliche_row">  
                                <td>
                                    <label><?php echo esc_html__( 'Field Label:', 'wpresidence' ); ?></label>
                                    <input name="agent_custom_label[]" />
                                </td>  
                                <td>
                                    <label><?php echo esc_html__( 'Field Value: ', 'wpresidence' ); ?></label>
                                    <input name="agent_custom_value[]" />
                                </td>  
                                <td>
                                    <input type="button"   value="<?php echo esc_html__( 'Remove', 'wpresidence' ); ?>" class="button button-primary remove_parameter_button" />
                                </td>  
