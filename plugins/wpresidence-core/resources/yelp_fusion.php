...
function wpestate_obtain_bearer_token() {
    ...
    return   $yelp_client_api_key_2018  =   wpresidence_get_option('wp_estate_yelp_client_api_key_2018','');
    try {
...
function search($bearer_token, $term, $location) {
    ...
    $url_params['limit'] = wpresidence_get_option('wp_estate_yelp_results_no','');
      $API_HOST = "https://api.yelp.com";
    $SEARCH_PATH = "/v3/businesses/search";
