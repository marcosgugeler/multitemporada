                ...
                array(
                    ...
                    'params'            =>  array(
                        ...
                        array(
                            ...
                            "description" => esc_html__("Select 1,2,3","wpresidence-core")
                        ), array(
                            "type" => "textfield",
                            "holder" => "div",
                            "class" => "",
...
function wpestate_generate_category_values_shortcode(){
        ...
        if($property_category_values===false){
            ...
            if(function_exists('wpestate_set_transient_cache')){
                wpestate_set_transient_cache('wpestate_js_composer_property_category_label',$all_tax_labels,60*60*4);
...
function wpestate_generate_action_values_shortcode(){
    ...
    if($property_action_category_values===false){
        ...
        if(function_exists('wpestate_set_transient_cache')){
            wpestate_set_transient_cache('wpestate_js_composer_property_action_label',$all_tax_labels,60*60*4);
...
function wpestate_generate_city_values_shortcode(){
    ...
    if($property_city_values===false){
        ...
        if(function_exists('wpestate_set_transient_cache')){
            wpestate_set_transient_cache('wpestate_js_composer_property_city_label',$all_tax_labels,60*60*4);
...
function wpestate_generate_area_values_shortcode(){
    ...
    if($property_area_values===false){
        ...
        if(function_exists('wpestate_set_transient_cache')){
            wpestate_set_transient_cache('wpestate_js_composer_property_area_label',$all_tax_labels,60*60*4);
...
function wpestate_generate_county_values_shortcode(){
    ...
    if($property_county_state_values===false){
        ...
        if(function_exists('wpestate_set_transient_cache')){
            wpestate_set_transient_cache('wpestate_js_composer_property_county_label',$all_tax_labels,60*60*4);
...
function wpestate_generate_all_tax(){
    ...
    $all_tax1    = false;
    if(function_exists('wpestate_request_transient_cache')){
        $all_tax1 = wpestate_request_transient_cache ('wpestate_js_composer_all_tax');
    }
...
function wpestate_generate_all_tax_labels(){
    ...
    $all_tax1    = false;
    if(function_exists('wpestate_request_transient_cache')){
        $all_tax1 = wpestate_request_transient_cache ('wpestate_js_composer_all_tax_labels');
    }
