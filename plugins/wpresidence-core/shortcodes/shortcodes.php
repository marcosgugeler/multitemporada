...
function wpestate_contact_us_form($attributes, $content = null){
    ...
    $return_string.='  <div class="shortcode_contact_form sh_form_align_'.$text_align.'">
        ...
        <input type="text" placeholder="'.esc_html__('Your Name','wpresidence-core').'" required="required"   id="foot_contact_name_sh"  name="contact_name" class="form-control" value="" tabindex="373"> 
        <input type="email" required="required" placeholder="'. esc_html__('Your Email','wpresidence-core').'"  id="foot_contact_email_sh" name="contact_email" class="form-control" value="" tabindex="374">
        <input type="email" required="required" placeholder="'.esc_html__('Your Phone','wpresidence-core').'"  id="foot_contact_phone_sh" name="contact_phone" class="form-control" value="" tabindex="374">
        <textarea placeholder="'.esc_html__('Type your message...','wpresidence-core').'" required="required" id="foot_contact_content_sh" name="contact_content" class="form-control" rows="4" tabindex="375"></textarea>
        ...
        $return_string.='  <div class="btn-cont">
            <button type="submit" id="btn-cont-submit_sh" class="wpresidence_button">'.esc_html__('Send Message','wpresidence-core').'</button>
...
function wpestate_property_page_map_function( $attributes,$content = null) {
    ...
    $return_string ='<div class="google_map_shortcode_wrapper  '.wpresidence_return_class_leaflet().'">
                ...
                $return_string .= '<div id="slider_enable_street_sh" data-placement="bottom" data-original-title="'.esc_html__('Street View','wpresidence-core').'"> <i class="fa fa-location-arrow"></i>    </div>';
...
function wpestate_places_list_function($attributes, $content = null) {
  ...
  // max 4 per row
    ...
    $return_string ='<div class="article_container places_list_'.$place_type.'">'. ob_get_contents().'</div>';
    ob_end_clean(); 
    $is_shortcode       =0;
    return $return_string;
...
function wpestate_advanced_search_function($attributes, $content = null){
        ...
        if($custom_advanced_search=='yes'){
                ...
                if($adv_search_type==10 ){
                    $adv_actions_value=esc_html__('All Actions','wpresidence-core');
                ...
                if($adv_search_type==11 ){
                    $adv_actions_value=esc_html__('All Actions','wpresidence-core');
                    $adv_actions_value1='all';
                    $adv_categ_value    = esc_html__('All Types','wpresidence-core');
                ...
                $return_string.= '<div class="featured_article_type2">
                       <div class="featured_img_type2" style="background-image:url('.$preview[0] .')">
                            ...
                            <div class="featured_article_type2_title_wrapper">
                                ...
                                <h2>'.$title.'</h2>
                                <div class="featured_read_more"><a href="'.$link.'">'.esc_html__('read more','wpresidence-core').'</a> <i class="fa fa-angle-right"></i></div>    
                            </div>        
                        </div>
                    </div>';
