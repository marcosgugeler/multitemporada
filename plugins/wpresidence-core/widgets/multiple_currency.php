...
//		$this->WP_Widget('multiple_currency_widget', 'Wp Estate: Multiple currency widget', $widget_ops, $control_ops);
	...
	function form($instance){
		$defaults = array(
                            'title' => esc_html__('Change Your Currency','wpresidence-core'),
                            );
	...
	function widget($args, $instance){
		...
		if($title) {
			print $before_title.$title.$after_title;
                ...
                $multiple_cur           =   wpresidence_get_option( 'wp_estate_multi_curr'); 
                ...
                $display.='<input type="hidden" id="wpestate_change_currency" value="'.esc_html($ajax_nonce).'" />    ';                 
