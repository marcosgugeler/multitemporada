...
if( !function_exists('wpestate_general_design_elements') ):
    function wpestate_general_design_elements(){
        ...
        if( $adv_font_color  !=''){ 
            ...
            .adv6-holder .adv_search_slider p label, 
            .adv6-holder .adv_search_slider p span,#amount_wd            {
        ...
        case 'link_to_page':
            ...
            if($text==''){
                if ( strpos($icon, 'fa-') !== false){
                    ...
                    print '<a href="'.esc_url($link).'"><img src="'.esc_url($icon).'" alt="'.esc_html__('details','wpresidence').'"></a>';
                }
            }else{
...
function wpestate_share_unit_desing($prop_id,$is_single=1){
    ...
    ?>
        ...
        <a href="<?php print esc_html($protocol);?>://twitter.com/home?status=<?php echo esc_html($twiter_status); ?>" class="social_tweet" target="_blank"></a>
        ...
        <a href="mailto:email@email.com?<?php echo trim(esc_url($email_link));?>" data-action="share email"  class="social_email"></a>
