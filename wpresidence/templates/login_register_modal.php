...
<div id="modal_login_wrapper">
    ...
    <div class="modal_login_container">
        ...
        <div id="login-modal_close"></div>
            ...
            <h3   id="login-div-title-topbar"><?php esc_html_e('Sign into your account','wpresidence');?></h3>
            ...
            <h3  id="register-div-title-topbar"><?php esc_html_e('Create an account','wpresidence');?></h3>
            ...
            <h3   id="forgot-div-title-topbar"><?php esc_html_e('Reset Password','wpresidence');?></h3>
