...
if($show_adv_search!=='no'){
    ...
    $use_float_search_form      =   wpresidence_get_option('wp_estate_use_float_search_form','');
    ...
    <div class="search_wrapper search_wr_<?php print esc_attr($adv_search_type.' '. $page_without_search.' '.$close_class_wr.' '.$search_start_class);?>" id="search_wrapper"  data-postid="<?php echo intval($post_id); ?>">       
