...
<div class="blog-unit-wrapper">
    ...
    <div class="blog_unit_content <?php print esc_html($unit_class);?>">
        ...
        <div class="blog_unit_meta widemeta">
            <span class="span_widemeta"><i class="fa fa-file-o"></i><?php the_category(', ');?></span><span class="span_widemeta"><i class="fa fa-calendar-o"></i><?php print get_the_date('M d, Y');?></span><span class="span_widemeta"><i class="fa fa-comment-o"></i><?php comments_number( '0','1','%');?></span>
            <a class="read_more" href="<?php the_permalink(); ?>"><?php esc_html_e('Continue Reading','wpresidence'); ?><i class="fa fa-angle-right"></i></a>
        </div>
