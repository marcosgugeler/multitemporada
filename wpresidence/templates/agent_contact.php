...
<div class="agent_contanct_form ">
    ...
    if ( basename(get_page_template())!='contact_page.php') { ?>
        ...
        ?>
            <div id="schedule_meeting"><?php esc_html_e('Schedule a showing?','wpresidence');?></div>    
        <?php 
        } 
        ?>
    ...
    <?php if ( ($contact_form_7_agent =='' && basename(get_page_template())!='contact_page.php') || ( $contact_form_7_contact=='' && basename(get_page_template())=='contact_page.php')  ){ ?>
        ...
        <div class="schedule_wrapper ">    
            <div class="col-md-6">
                <input name="schedule_day" id="schedule_day" type="text"  placeholder="<?php esc_html_e('Day', 'wpresidence'); ?>" aria-required="true" class="form-control">
            </div>
