...
<div class="<?php echo esc_html($col_class);?> listing_wrapper" data-org="<?php echo esc_attr($col_org);?>" data-listid="<?php echo intval($post->ID);?>" > 
         ...
         wpestate_build_unit_custom_structure($wpestate_custom_unit_structure,$post->ID,$wpestate_property_unit_slider);
               ...
               $measure_sys            = esc_html ( wpresidence_get_option('wp_estate_measure_sys','') ); 
                ...
                if(  $wpestate_property_unit_slider==1){
                    ...
                    <div id="property_unit_carousel_'.esc_attr($unique_prop_id).'" class="carousel property_unit_carousel slide " data-ride="carousel" data-interval="false">
                        ...
                        <a href="'.esc_url($link).'"> </a>'; //slides and thumb escaped above
            ...
            <?php if ($align_class=='the_list_view') {?>
                <div class="listing_details the_list_view" style="display:block;">
                    <?php   
                        echo wpestate_strip_excerpt_by_char(get_the_excerpt(),160,$post->ID);
                    ?>
                </div>   
        
                <div class="listing_details half_map_list_view" >
                    <?php   
                        echo wpestate_strip_excerpt_by_char(get_the_excerpt(),75,$post->ID);
                    ?>
                </div>   
            ...
            <div class="property_listing_details">
                <?php 
                    ...
                    if($property_size!=''){
                        print ' <span class="infosize">'.($property_size).'</span>';//escaped above
                    }
                    
                    echo '<a href="'.esc_url($link).'" class="unit_details_x">'.esc_html__('full info','wpresidence').'</a>';
                  ?>
            </div>
