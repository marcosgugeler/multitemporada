        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="col-md-6 agency_details">
                    <?php
                        ...
                        if($agency_facebook!=''){
                            print ' <a class="agency_social" href="'.esc_url($agency_facebook).'" target="_blank"><i class="fa fa-facebook"></i></a>';
                        }

                        if($agency_twitter!=''){
                            print ' <a class="agency_social" href="'.esc_url($agency_twitter).'" target="_blank"><i class="fa fa-twitter"></i></a>';
                        }
                        if($agency_linkedin!=''){
                            print ' <a class="agency_social" href="'.esc_url($agency_linkedin).'" target="_blank"><i class="fa fa-linkedin"></i></a>';
                        }
                        if($agency_pinterest!=''){
                            print ' <a class="agency_social" href="'.esc_url($agency_pinterest).'" target="_blank"><i class="fa fa-pinterest"></i></a>';
                        }
                        if($agency_instagram!=''){
                            print ' <a class="agency_social" href="'.esc_url($agency_instagram).'" target="_blank"><i class="fa fa-instagram"></i></a>';
                        }
                    ...
                    <?php 
                    if($agency_email!=''){
                        echo '<div class="agency_detail agency_email"><strong>'.esc_html__('Email:','wpresidence').'</strong> <a href="mailto:'.esc_url($agency_email).'">'.esc_html($agency_email).'</a></div>';
                    }
                    ?>
                    ...
                    <?php 
                    if($agency_mobile!=''){
                        echo '<div class="agency_detail agency_mobile"><strong>'.esc_html__('Mobile:','wpresidence').'</strong> <a href="tel:'.esc_url($agency_mobile).'">'.esc_html($agency_mobile).'</a></div>';
                    }
                    ?>
                    <?php 
                    if($agency_phone!=''){
                        echo '<div class="agency_detail agency_phone"><strong>'.esc_html__('Phone:','wpresidence').'</strong> <a href="tel:'.esc_url($agency_phone).'">'.esc_html($agency_phone).'</a></div>';
                    }
                    ?>
            ...
            <div class="col-md-12 developer_content">
                ...
                <div class="col-md-4">
                    ...
                    if($agency_website!=''){
                        echo '<div class="agency_detail agency_taxes"><strong>'.esc_html__('Website:','wpresidence').'</strong> <a href="http://'.esc_url($agency_website).'" target="_blank">'.esc_html($agency_website).'</a></div>';
                    }
                    ?>  
                    <?php 
                    if($agency_skype!=''){
